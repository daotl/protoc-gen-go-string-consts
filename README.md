...
[![Build Status](https://img.shields.io/github/checks-status/daotl/protoc-gen-go-string-consts/main?color=black&style=for-the-badge&logo=github)][github-actions]
[![Code Coverage](https://img.shields.io/codecov/c/github/daotl/protoc-gen-go-string-consts?color=blue&logo=codecov&style=for-the-badge)][github-actions-tests]
...
[![License](https://img.shields.io/github/license/daotl/protoc-gen-go-string-consts?color=red&style=for-the-badge&logo=unlicense)][project-license]
[![Go v1.24](https://img.shields.io/badge/Go-%20v1.24-black?style=for-the-badge&logo=go)][gomod-file]

Protobuf plugin that generates go string constants from enums.
...
`protoc-gen-go-string-consts` on their end
...
```sh
git clone https://github.com/daotl/protoc-gen-go-string-consts
cd protoc-gen-go-string-consts
```
</details>
...
This section will guide you to setup a fully-functional local copy of `protoc-gen-go-string-consts`
...
from [`protoc-gen-go-string-consts's` Makefile][makefile-file] (most of which are
OS-independent)!

### Installing dependencies

To install all dependencies associated with `protoc-gen-go-string-consts`, run the
command
...
The pre-commit hooks used by `protoc-gen-go-string-consts` are located within the
...
Tests in `protoc-gen-go-string-consts` are classified as *fast* and *slow* - depending
...
|      `run`     	| Run *protoc-gen-go-string-consts*                           	|       NA      	|
|  `docker-gen`  	| Create production docker image for *protoc-gen-go-string-consts* 	|     docker    	|
|  `docker-debug`  	| Create debug-friendly docker image for *protoc-gen-go-string-consts* 	|     docker    	|
...
```text
protoc-gen-go-string-consts_<version>_<target-os>_<architecture>.<extension>
```
...
```sh
protoc-gen-go-string-consts_v1.2.1_windows_x86_64.exe
```
...
To run `protoc-gen-go-string-consts` in a docker container, read the instructions in
[docker section](./docker).

### Running `protoc-gen-go-string-consts`

To run protoc-gen-go-string-consts, use the command
...
`protoc-gen-go-string-consts` is powered by a template generated using [`go-template`][go-template-link]
